    ...
    return (
        <div className="h-screen text-white bg-black">
            ...
            <div className="mt-20 flex justify-center">
                <svg onClick={() => {window.open("https://github.com/Shubhashish-Chakraborty")}} fill="currentColor" stroke="currentColor" className="size-10 cursor-pointer hover:scale-110 transition-all duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
